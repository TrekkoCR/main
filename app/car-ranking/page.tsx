...
const sampleCars = [
  {
    ...
    image: "/placeholder.svg?height=100&width=150&text=Toyota",
    score: 87,
  },
  {
    id: "2",
    ...
    image: "/placeholder.svg?height=100&width=150&text=Hyundai",
    score: 82,
  },
  {
    id: "3",
    ...
    image: "/placeholder.svg?height=100&width=150&text=Nissan",
    score: 91,
  },
]

export default function CarRankingPage() {
  ...
  return (
    <div className="container mx-auto py-6 max-w-4xl">
      <div className="flex items-center justify-between mb-4">
        <h1 className="text-3xl font-bold">Car Ranking</h1>
      </div>
      ...
      <Card className="mb-8">
        <CardContent className="pt-6">
          <h2 className="text-xl font-semibold mb-4">Evaluar vehículos</h2>
          <p className="text-sm text-muted-foreground mb-4">
            Ingresa los enlaces de los anuncios o sube fotografías de los vehículos que te interesan evaluar. Nuestro
            sistema analizará las características y te ofrecerá una evaluación detallada.
          </p>
...
https://ejemplo.com/auto2"
            ...
            <div className="flex gap-2">
              <Button variant="outline" className="shadow-soft-sm shadow-soft-hover">
