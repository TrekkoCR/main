...
import { FinancingOption } from "@/components/financing-option"
                  ...
                  <TabsContent value="review" className="pt-4">
                    <div className="space-y-4">
                      <p className="text-sm">
                        ...
                        económico. Este modelo destaca por su bajo consumo de combustible y su historial de durabilidad.
                      </p>
                      <p className="text-sm">
                        Con un kilometraje de 45,000 km, este vehículo todavía tiene mucha vida útil por delante. Toyota
                        es conocida por fabricar motores que pueden superar fácilmente los 300,000 km con el
