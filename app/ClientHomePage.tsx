    ...
    <div className={`bg-white ${isChatMode ? "h-screen flex flex-col" : "min-h-screen"}`}>
      ...
      {!isChatMode ? (
        ...
        <div className="flex flex-col h-full">
          {/* Chat Messages */}
          <section className="flex-1 py-6 sm:py-8 px-4 sm:px-6 pb-32">
          ...
          <section className="fixed bottom-0 left-0 md:left-64 right-0 bg-white py-4 px-4 sm:px-6 border-t border-gray-200 z-20 shadow-lg">
