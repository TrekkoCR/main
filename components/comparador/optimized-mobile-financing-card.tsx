...
function OptimizedMobileFinancingCard({ option, onClick, index = 0, priority = false }: MobileFinancingCardProps) {
  return (
    <LazyLoadWrapper
      threshold={0.1}
      rootMargin="100px"
...
export default memo(OptimizedMobileFinancingCard, (prevProps, nextProps) => prevProps.option.id === nextProps.option.id)
